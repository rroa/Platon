...
public partial class Convalidaciones : System.Web.UI.Page
{
    ...
    ExoneracionTableAdapter ExoneraconTA = new ExoneracionTableAdapter();
    ...
    protected void btnConvalidar_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                ExoneraconTA.Insert(Convert.ToInt32(Session["id_estudiante"]), DateTime.Now, Convert.ToInt32(ddlmateria.SelectedItem.Value), Convert.ToInt32(txtNota.Text), txtDescr.Text, Convert.ToInt32(Session["idUsuario"]));
