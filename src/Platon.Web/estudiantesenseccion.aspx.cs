...
public partial class estudiantesenseccion : System.Web.UI.Page
{
    ...
    {
        //ReportParameter session = new ReportParameter();
        //session.Name = "session";
        //session.Values.Add(GridView1.SelectedDataKey.Value.ToString());

        //ReportViewer1.ServerReport.SetParameters(new ReportParameter[] { session });
