<%@ Page Language="C#" MasterPageFile="~/mpDirectiva.master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="formulario2.aspx.cs" Inherits="estudiantesenseccion" %>
...
<div align=center style="text-align: left">
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt"
        ...
        <LocalReport ReportPath="reportes\formulario2_1.rdlc">
            <DataSources>
    ...
    <rsweb:ReportViewer ID="ReportViewer4" runat="server" Font-Names="Verdana" Font-Size="8pt"
        Height="400px" Width="100%">
        <LocalReport ReportPath="reportes\formulario2_2.rdlc">
            <DataSources>
    ...
    <strong>AULA VIRTUAL<br />
        <rsweb:ReportViewer ID="ReportViewer2" runat="server" Font-Names="Verdana" Font-Size="8pt"
            Height="400px" Width="100%">
            <LocalReport ReportPath="reportes\formulario2_AV.rdlc">
                <DataSources>
        ...
        <rsweb:ReportViewer ID="ReportViewer3" runat="server" Font-Names="Verdana" Font-Size="8pt"
            Height="400px" Width="100%">
            <LocalReport ReportPath="reportes\formulario2_Final.rdlc">
                <DataSources>
