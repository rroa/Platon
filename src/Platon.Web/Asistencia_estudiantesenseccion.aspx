<%@ Page Language="C#" MasterPageFile="~/mpDirectiva.master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="Asistencia_estudiantesenseccion.aspx.cs" Inherits="estudiantesenseccion" %>
...
<div align=center style="text-align: left">
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt"
        ...
        <LocalReport ReportPath="reportes\Asistencia_EstudiantesenSeccion.rdlc">
            <DataSources>
