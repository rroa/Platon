...
public partial class RecordNotas : System.Web.UI.Page
{
    ...
    void LocalReport_SubreportProcessing(object sender, Microsoft.Reporting.WebForms.SubreportProcessingEventArgs e)
    {
        ...
        //e.DataSources.Add(new Microsoft.Reporting.WebForms.ReportDataSource("dsUniversidad_View_RecordDeNotas", ObjectDataSource2));

        //e.DataSources.Add(new Microsoft.Reporting.WebForms.ReportDataSource("dsUniversidad_View_RecordDeNotas", ObjectDataSource1));
