<%@ Page Language="C#" MasterPageFile="~/mpDirectiva.master" AutoEventWireup="true" CodeFile="solicitudIngresoAct.aspx.cs" Inherits="solicitudIngreso" %>
<%@  Register TagPrefix="ew"   Namespace="eWorld.UI.Compatibility"  Assembly="eWorld.UI.Compatibility" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <span style="font-size: 23px; font-family: Arial">EDITAR SOLICITUD DE INGRESO
        <hr />
        <span style="font-size: 9pt">Cargar datos de estudiante admitido: Apellido del estudiante</span><asp:TextBox
            ID="txtapellidoadmitido" runat="server" Width="212px"></asp:TextBox><span style="font-size: 12px;
                font-family: Arial">&nbsp;</span><asp:Button ID="btnAdmitido" runat="server" Text="Buscar" />
        ...
        <asp:ObjectDataSource ID="odsAdmitidos" runat="server" DeleteMethod="Delete" OldValuesParameterFormatString="original_{0}"
            SelectMethod="GetDataByApellido" TypeName="dsUniversidadTableAdapters.tblAdmision_StudentTableAdapter">
            <DeleteParameters>
                    ...
                    <tr style="font-family: Arial">
                        ...
                        <td colspan="2" style="padding-left: 5px; text-align: left">
                            <span>Lugar de trabajo &nbsp; &nbsp; &nbsp;
                                <asp:TextBox ID="txtlugartrabajo" runat="server" Width="206px"></asp:TextBox></span></td>
                    </tr>
                    <tr style="font-family: Arial">
                        <td align="left" style="padding-left: 5px; width: 203px; height: 21px">
                        ...
                        <td align="left" colspan="2" style="padding-left: 5px; height: 21px">Tel&eacute;fono del trabajo
