<%@ Page Language="C#" MasterPageFile="~/mpDirectiva.master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="formulario4.aspx.cs" Inherits="estudiantesenseccion" %>
...
<div align=center style="text-align: left">
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt"
        ...
        <LocalReport ReportPath="reportes\formulario4_1.rdlc">
            <DataSources>
                <rsweb:ReportDataSource DataSourceId="ObjectDataSource7" Name="dsUniversidad_Estudiantes_en_sesion" />
            </DataSources>
        </LocalReport>
    </rsweb:ReportViewer>
    ...
    <rsweb:ReportViewer ID="ReportViewer4" runat="server" Font-Names="Verdana" Font-Size="8pt"
        Height="400px" Width="100%">
        <LocalReport ReportPath="reportes\formulario4_2.rdlc">
            <DataSources>
    ...
    <rsweb:ReportViewer ID="ReportViewer5" runat="server" Font-Names="Verdana" Font-Size="8pt"
        Height="400px" Width="100%">
        <LocalReport ReportPath="reportes\formulario4_3.rdlc">
            <DataSources>
    ...
    <rsweb:ReportViewer ID="ReportViewer6" runat="server" Font-Names="Verdana" Font-Size="8pt"
        Height="400px" Width="100%">
        <LocalReport ReportPath="reportes\formulario4_4.rdlc">
            <DataSources>
    ...
    <strong>AULA VIRTUAL<br />
        <rsweb:ReportViewer ID="ReportViewer2" runat="server" Font-Names="Verdana" Font-Size="8pt"
            Height="400px" Width="100%">
            <LocalReport ReportPath="reportes\formulario4_AV.rdlc">
                <DataSources>
        ...
        <rsweb:ReportViewer ID="ReportViewer3" runat="server" Font-Names="Verdana" Font-Size="8pt"
            Height="400px" Width="100%">
            <LocalReport ReportPath="reportes\formulario4_Final.rdlc">
                <DataSources>
