<%@ Page Language="C#" MasterPageFile="~/mpDirectiva.master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="formulario3.aspx.cs" Inherits="estudiantesenseccion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">        
    ...
    refrescar dentro del visualizador de reportes.</span></span></span><br />
        ...
        <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox><span style="font-size: 12px; font-family: Arial"> </span>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt"
            ...
            <LocalReport ReportPath="reportes\formulario3_1.rdlc">
                <DataSources>
        ...
        <rsweb:ReportViewer ID="ReportViewer4" runat="server" Font-Bold="False" Font-Names="Verdana"
            Font-Size="8pt" Height="400px" Width="100%">
            <LocalReport ReportPath="reportes\formulario3_2.rdlc">
                <DataSources>
        ...
        <br />
        <strong>SEMANA 3</strong><rsweb:ReportViewer ID="ReportViewer5" runat="server" Font-Names="Verdana"
            Font-Size="8pt" Height="400px" Width="100%">
            <LocalReport ReportPath="reportes\formulario3_3.rdlc">
                <DataSources>
        ...
        <strong>AULA VIRTUAL<br />
            <rsweb:ReportViewer ID="ReportViewer2" runat="server" Font-Names="Verdana" Font-Size="8pt"
                Height="400px" Width="100%">
                <LocalReport ReportPath="reportes\formulario3_AV.rdlc">
                    <DataSources>
                        <rsweb:ReportDataSource DataSourceId="ObjectDataSource5" Name="dsUniversidad_Estudiantes_en_sesion" />
                    </DataSources>
                </LocalReport>
            </rsweb:ReportViewer>
            ...
            <rsweb:ReportViewer ID="ReportViewer3" runat="server" Font-Names="Verdana" Font-Size="8pt"
                Height="400px" Width="100%">
                <LocalReport ReportPath="reportes\formulario3_Final.rdlc">
                    <DataSources>
                        <rsweb:ReportDataSource DataSourceId="ObjectDataSource6" Name="dsUniversidad_Estudiantes_en_sesion" />
                    </DataSources>
                </LocalReport>
            </rsweb:ReportViewer>
